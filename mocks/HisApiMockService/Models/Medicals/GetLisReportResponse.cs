...
public class GetLisReportResponse
{
    ...
    public List<ListApplyInfoResponse> applyInfoList { get; set; }
    ...
    /// 正常报告项列表
    /// </summary>
    public List<LisReportItemInfo> ReportItemList { get; set; }

    /// <summary>
    /// 微生物报告项列表
    /// </summary>
    public List<LisMicroReportItemInfo> MicroReportItemList { get; set; }
