...
/// Ddp His返回的药品清单信息
/// </summary>
public class DdpHisMedicineResponse
{
    ...
    /// 抗菌药  0非抗菌药,1非限制级,2限制级,3特殊使用级
    /// </summary>
    public float? AntibioticLevel { get; set; }
    ...
    /// 平台标识
    /// </summary>
    public PlatformType PlatformType { get; set; } = PlatformType.EmergencyTreatment;

    /// <summary>
    /// 门诊拆分属性 0最小单位总量取整 1包装单位总量取整 2最小单位每次取整 3包装单位每次取整 4最小单位可拆分
    /// </summary>
    public MedicineUnPack Unpack { get; set; } = MedicineUnPack.RoundByMinUnitAmount;
