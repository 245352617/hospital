...
public static class ConvertExtension
{
    ...
    /// <returns></returns>
    public static string ToSmallHump(this string prop)
    {
        return prop[..1].ToLower() + prop[1..];
    }
    ...
    /// <returns></returns>
    [Diagnostics.CodeAnalysis.SuppressMessage("Usage", "VSTHRD002:避免有问题的同步等待", Justification = "<挂起>")]
