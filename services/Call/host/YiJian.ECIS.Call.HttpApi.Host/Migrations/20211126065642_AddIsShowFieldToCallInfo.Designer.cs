...
namespace YiJian.ECIS.Call.Migrations
{
    ...
    [Migration("20211126065642_AddIsShowFieldToCallInfo")]
    partial class AddIsShowFieldToCallInfo
    {
            ...
            modelBuilder.Entity("YiJian.ECIS.Call.Domain.CallCenter.CallInfo", b =>
                {
                    ...
                    b.Property<string>("ToHospitalWay")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)")
                        .HasComment("来院方式");
                    ...
                    b.Property<string>("TriageDirection")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)")
                        .HasComment("分诊去向编码");
