        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Diagnose = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true, comment: "诊断"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    T = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "体温（单位℃）"),
                    P = table.Column<int>(type: "int", nullable: false, comment: "脉搏P(次/min)"),
                    HR = table.Column<int>(type: "int", nullable: false, comment: "心率(次/min)"),
                    R = table.Column<int>(type: "int", nullable: false, comment: "呼吸(次/min)"),
                    BP = table.Column<int>(type: "int", nullable: false, comment: "血压BP收缩压(mmHg)"),
                    BP2 = table.Column<int>(type: "int", nullable: false, comment: "血压BP舒张压(mmHg)"),
                    SPO2 = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "血氧饱和度SPO2 %"),
                    ...
                    Nurse = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true, comment: "护士签名"),
                    SheetIndex = table.Column<int>(type: "int", nullable: false, comment: "新建页索引"),
                    NursingDocumentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "护理单Id"),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false, comment: "内容"),
