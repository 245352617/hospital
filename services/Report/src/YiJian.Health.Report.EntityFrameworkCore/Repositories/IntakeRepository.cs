...
{
    public class IntakeRepository : EfCoreRepository<ReportDbContext, Intake, Guid>, IIntakeRepository
    {
        /// <summary>
        /// 瞳孔评估
        /// </summary>
        /// <param name="dbContextProvider"></param>
        public IntakeRepository(IDbContextProvider<ReportDbContext> dbContextProvider)
