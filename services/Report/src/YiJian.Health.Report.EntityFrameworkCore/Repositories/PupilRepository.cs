...
{
    public class PupilRepository : EfCoreRepository<ReportDbContext, Pupil, Guid>, IPupilRepository
    {
        /// <summary>
        /// 瞳孔评估
        /// </summary>
        /// <param name="dbContextProvider"></param>
        public PupilRepository(IDbContextProvider<ReportDbContext> dbContextProvider)
