...
using YiJian.Report.PhraseCatalogues;
...
namespace YiJian.EMR.DailyExpressions
{
    ...
    /// </summary>
    [Authorize]
    public class PhraseAppService : ReportAppService, IPhraseAppService
    {
        ...
        /// 
        /// </summary>
        /// <param name="phraseCatalogueRepository"></param>
