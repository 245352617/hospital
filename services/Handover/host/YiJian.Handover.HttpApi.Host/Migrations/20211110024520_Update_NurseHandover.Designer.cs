...
namespace YiJian.Handover.Migrations
{
    ...
    [Migration("20211110024520_Update_NurseHandover")]
    partial class Update_NurseHandover
    {
            ...
            modelBuilder.Entity("YiJian.Handover.NursePatients", b =>
                {
                    ...
                    b.Property<string>("SuccessionDoctorCode")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("接班医生编码");

                    b.Property<string>("SuccessionDoctorName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("接班医生名称");
