...
namespace YiJian.Handover.Migrations
{
    ...
    [Migration("20211111082051_Update_NursePatients_111116")]
    partial class Update_NursePatients_111116
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YiJian.Handover.NurseHandover", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("Status")
                        .HasColumnType("int")
                        .HasComment("交班状态，0：未提交，1：提交交班");

                    b.HasKey("Id");

                    b.HasIndex("HandoverDate");

                    b.ToTable("Handover_NurseHandovers");

                    b
                        .HasComment("护士交班");
                });

            modelBuilder.Entity("YiJian.Handover.NursePatients", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("HandoverNurseCode")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("交班护士编码");

                    b.Property<string>("HandoverNurseName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("交班护士名称");
                    ...
                    b.Property<Guid>("NurseHandoverId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("护士交班id");
                    ...
                    b.Property<string>("SuccessionNurseCode")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("接班护士编码");

                    b.Property<string>("SuccessionNurseName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("接班护士名称");
                    ...
                    b.HasIndex("NurseHandoverId");

                    b.ToTable("Handover_NursePatients");
            ...
            modelBuilder.Entity("YiJian.Handover.NursePatients", b =>
                {
                    b.HasOne("YiJian.Handover.NurseHandover", null)
                        .WithMany("NursePatients")
                        .HasForeignKey("NurseHandoverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
