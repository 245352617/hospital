...
#dotnet sonarscanner begin /k:"Handover" /d:sonar.host.url="http://192.168.1.179:59000"  /d:sonar.login="7ac199c604c46c29c3e78c724d8106ad1751df0f"

dotnet publish -c Release -o $ROOT/publish $ROOT/YiJian.Handover.HttpApi.Host.csproj
