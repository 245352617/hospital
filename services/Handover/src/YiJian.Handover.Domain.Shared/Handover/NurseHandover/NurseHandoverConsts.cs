namespace YiJian.Handover
{
    ...
    /// 护士交班 表字段长度常量
    /// </summary>
    public class NurseHandoverConsts
    {  
        /// <summary>
        /// 患者id(50)
        /// </summary>
        ...
        /// 性别名称(20)
        /// </summary>
        public static int MaxSexNameLength { get; set; } = 20;
        /// <summary>
        /// 年龄(20)
        /// </summary>
        ...
        /// 班次名称(100)
        /// </summary>
        public static int MaxShiftSettingNameLength { get; set; } = 100;
        /// <summary>
        /// 创建人编码(50)
        /// </summary>
        public static int MaxCreationCodeLength { get; set; } = 50;
        /// <summary>
        /// 创建人名称(100)
        /// </summary>
        public static int MaxCreationNameLength { get; set; } = 100;
    }
}