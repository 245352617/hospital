...
namespace YiJian.Handover
{
    ...
    [Serializable]
    public class DoctorHandoverCreation
    {
        /// <summary>
        /// 交班日期
        /// </summary>
        ...
        /// 统计
        /// </summary>
        public DoctorPatientStatisticCreation PatientStatistics { get; set; }

        /// <summary>
        /// 交班患者
        /// </summary>
        public List<DoctorPatientsCreation> DoctorPatients { get; set; }
    }
}