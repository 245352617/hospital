...
/// </summary>
[Serializable]
public class MedicineFrequencyCreation
{
    /// <summary>
    /// 频次编码
    /// </summary>
    [DynamicStringLength(typeof(MedicineFrequencyConsts), nameof(MedicineFrequencyConsts.MaxFrequencyCodeLength), ErrorMessage = "频次编码最大长度不能超过{1}!")]
