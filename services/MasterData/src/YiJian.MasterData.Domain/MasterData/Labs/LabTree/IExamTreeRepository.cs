...
namespace YiJian.MasterData.Domain
{
    ...
    /// </summary>
    public interface ILabTreeRepository : ITreeRepository<LabTree>
    {
        /// <summary>
        /// 绑定projectCode
        /// </summary>
        ...
        /// <returns></returns>
        public Task<bool> UpdateAsync(string Id, string Name, decimal sort);
        ...
        /// </summary>
        /// <returns></returns>
        public Task<IList<LabTree>> GetNoBindTreeProjectAsync();
    }
}
