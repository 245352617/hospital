namespace YiJian.Recipe
{
    ...
    /// 分诊患者id 领域服务测试
    /// </summary>
    public class OperationApplyManagerTests : RecipeDomainTestBase
    {
        private readonly OperationApplyManager _operationApplyManager;

        public OperationApplyManagerTests()
        {            
        ...
        { 
            ...
            var operationApply = await _operationApplyManager.CreateAsync(_guidGenerator.Create(), 
                pIId,   // 分诊患者id
            ...
            operationApply.Id.ShouldNotBeNull();
            */
        }
