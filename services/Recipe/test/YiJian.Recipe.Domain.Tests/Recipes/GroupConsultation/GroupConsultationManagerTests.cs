...
namespace YiJian.Recipes.GroupConsultation
{
    ...
    /// 会诊管理 领域服务测试
    /// </summary>
    public class GroupConsultationManagerTests : RecipeDomainTestBase
    {
        private readonly GroupConsultationManager _groupConsultationManager;

        public GroupConsultationManagerTests()
        {            
        ...
        { 
            ...
            var groupConsultation = await _groupConsultationManager.CreateAsync(_guidGenerator.Create(), 
                pIID,   // 分诊患者id
                patientId,      // 患者id
                typeCode,       // 会诊类型
                typeName,
            ...
            groupConsultation.Id.ShouldNotBeNull();
            */
        }
