        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Request = table.Column<string>(type: "ntext", nullable: true, comment: "请求参数"),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommitSerialNo = table.Column<int>(type: "int", nullable: false, comment: "提交序列号"),
                    ...
                    IsAdditionalPrice = table.Column<bool>(type: "bit", nullable: false, comment: "是否是加收价格 1=是加收价格， 0=不是加收价格"),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuideName = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true, comment: "指引名称 关联 ExamNote表name"),
                    DoctorsAdviceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "医嘱Id"),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "病人ID"),
                    ...
                    DoctorName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "医生姓名"),
                    MedType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "医嘱类型 处方：CF   非处方:YJ"),
                    ChannelNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "渠道识别号  4.5.3医嘱信息回传（his提供、需对接集成平台） chargeDetailNo projectItemNo"),
                    HisNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "His识别号 对应his处方识别（C）、医技序号（Y）  可用于二维码展示等"),
                    ChannelNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "HIS申请单号 处方：处方号码  医技：申请单id（检验、检查返回）"),
                    MedicalNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "病历号 患者主索引id、用于条形码展示"),
                    LgzxyyPayurl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true, comment: "支付二维码  深圳市龙岗中心医院微信公众"),
                    LgjkzxPayurl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true, comment: "支付二维码 深圳市龙岗健康在线支付二维码"),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplyTime = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "申请时间")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Index = table.Column<int>(type: "int", nullable: false, comment: "前端定位索引，自己录入自己定位"),
                    PlatformType = table.Column<int>(type: "int", nullable: false, comment: "系统标识: 0=急诊，1=院前"),
                    PIID = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "患者唯一标识"),
                    PatientId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "患者Id"),
                    PatientName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true, comment: "患者名称"),
                    Code = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "医嘱编码"),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false, comment: "医嘱名称"),
                    Specification = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true, comment: "规格型号"),
                    ApplyTime = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "开嘱时间"),
                    ApplyDoctorCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "申请医生编码"),
                    ApplyDoctorName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "申请医生"),
                    ApplyDeptCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "申请科室编码"),
                    ...
                    IsPush = table.Column<bool>(type: "bit", nullable: false, comment: "标记是否已经推送过,默认是否"),
                    Remarks = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true, comment: "医嘱说明")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstCatalogCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "一级检查类别编码"),
                    FirstCatalogName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true, comment: "一级检查目录名称"),
                    ClinicalSymptom = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true, comment: "临床症状"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DoctorsAdviceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedType = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: true, comment: "对应his处方识别（C）、医技序号（Y）"),
                    ...
                    BillState = table.Column<int>(type: "int", nullable: false, comment: "订单状态, 0.未缴费 1.已缴费 -1.已作废 2.已执行,3.已退费"),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrescriptionNo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "处方号"),
                    TemplateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "打印模板id"),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToxicLevel = table.Column<int>(type: "int", nullable: true, comment: "药理 0=普通药品,1=毒性药品,2=麻醉、精一药品，3=精二类，4=放射性，5=贵重药品，6=妊娠药品，7=狂犬疫苗"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalItemsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "药品附加项id"),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserName = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "用户名称"),
                    GroupName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "配置组"),
                    GroupCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "配置组编码"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "配置名称"),
                    Code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "配置编码"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyFrequency = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "HIS频次编码"),
                    FrequencyExecDayTimes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true, comment: "执行时间"),
                    ...
                    SpecimenName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true, comment: "标本"),
                    Remarks = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true, comment: "备注/说明"),
                    PrescribeTypeCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "医嘱类型编码"),
                    PrescribeTypeName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "医嘱类型：临嘱、长嘱、出院带药等"),
                    RecieveQty = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "领量(数量)"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstCatalogCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "一级目录编码"),
                    FirstCatalogName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true, comment: "一级分类名称"),
                    PartName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "检查部位"),
                    PartCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "检查部位编码"),
                    PositionCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "位置编码"),
                    PositionName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true, comment: "位置"),
                    ...
                    AddCard = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true, comment: "附加卡片类型 12.TCT细胞学检查申请单 11.病理检验申请单 16.门诊大型设备检查治疗项目审核、报告单（需两联）、需配合医保患者使用"),
                    GuideCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "指引Id 关联 ExamNote表code"),
                    GuideName = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true, comment: "指引名称 关联 ExamNote表name")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddCard = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true, comment: "加卡片类型 15.孕母血清胎儿唐氏综合征筛查申请单(早、中期)14.新型冠状病毒RNA检测申请单13.基于孕妇外周血胎儿 基于孕妇外周血胎儿13 、18 、21-三体综合征基因筛查申请单"),
                    GuideCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "指引Id 关联 ExamNote表code"),
                    GuideName = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true, comment: "指引名称 关联 ExamNote表name")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "诊疗处置类别代码"),
                    ProjectName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "诊疗处置类别名称")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PharmacyName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "药房"),
                    AntibioticPermission = table.Column<int>(type: "int", nullable: false, comment: "抗生素权限"),
                    PrescriptionPermission = table.Column<int>(type: "int", nullable: false, comment: "处方权"),
