...
dotnet publish -c Release -o $ROOT/bin/publish $ROOT/YiJian.Recipe.HttpApi.Host.csproj
...
echo "======== 发布容器镜像 ========"
docker save registry.szyjian.com/ecis2.0/recipe:pku | gzip > /root/data/ecis-recipe.tar.gz
docker push $image
