...
namespace YiJian.Recipe.Migrations
{
    ...
    [Migration("20240527061002_add_PrescriptionFlag")]
    partial class add_PrescriptionFlag
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YiJian.AuditLogs.Entities.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("HttpMethods")
                        .HasColumnType("int")
                        .HasComment("方法类型  GET = 0, POST = 1, PUT = 2,DELETE = 3,HEAD = 4,OPTIONS = 5, PATCH = 6");
                    ...
                    b.ToTable("RC_AuditLog", (string)null);

                    b.HasComment("HIS接口审计日志");
                });

            modelBuilder.Entity("YiJian.Cases.Entities.PatientCase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Presentmedicalhistory")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)")
                        .HasComment("现病史");
                    ...
                    b.ToTable("RC_PatientCase", (string)null);

                    b.HasComment("患者的病例信息");
                });

            modelBuilder.Entity("YiJian.DoctorsAdvices.Entities.DoctorsAdviceMap", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("RC_DoctorsAdviceMap", (string)null);

                    b.HasComment("医嘱映射表,只映射一个自增的Id");
                });
            ...
            modelBuilder.Entity("YiJian.DoctorsAdvices.Entities.DrugStockQuery", b =>
                {
                    ...
                    b.ToTable("RC_DrugStockQuery", (string)null);

                    b.HasComment("库存相关的信息");
                });

            modelBuilder.Entity("YiJian.DoctorsAdvices.Entities.ImmunizationRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("AcupunctureManipulation")
                        .HasColumnType("int")
                        .HasComment("针法，0=四针法，1=五针法");

                    b.Property<bool>("Confirmed")
                        .HasColumnType("bit")
                        .HasComment("是否确认的，回传给HIS之后就是确认的true，否则就是false");

                    b.Property<Guid>("DoctorAdviceId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("医嘱Id");

                    b.Property<int>("MedicineId")
                        .HasColumnType("int")
                        .HasComment("药品ID,HIS给过来的");
                    ...
                    b.Property<int>("Times")
                        .HasColumnType("int")
                        .HasComment("接种次数（第一次，第二次，第三次...）");

                    b.HasKey("Id");

                    b.HasIndex("DoctorAdviceId");

                    b.HasIndex("MedicineId");

                    b.ToTable("RC_ImmunizationRecord", (string)null);
            ...
            modelBuilder.Entity("YiJian.DoctorsAdvices.Entities.MedDetailResult", b =>
                {
                    ...
                    b.Property<string>("MedFee")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("费别 用于申请单费别显示");

                    b.Property<string>("MedNature")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("性质 用于申请单性质显示");
                    ...
                    b.ToTable("RC_MedDetailResult", (string)null);
                });
            ...
            modelBuilder.Entity("YiJian.DoctorsAdvices.Entities.MedicalTechnologyMap", b =>
                {
                    ...
                    b.Property<int>("ItemType")
                        .HasColumnType("int")
                        .HasComment("医嘱各项分类: 0=药品,1=检查项,2=检验项,3=诊疗项");

                    b.Property<Guid>("LPTId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("医技映射字典，包括检查，检验，诊疗外检");

                    b.HasKey("Id");

                    b.ToTable("RC_MedicalTechnologyMap", (string)null);

                    b.HasComment("医技映射字典，包括检查，检验，诊疗");
                });

            modelBuilder.Entity("YiJian.DoctorsAdvices.Entities.PrescribeCustomRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RC_PrescribeCustomRule", (string)null);

                    b.HasComment("自定义规则药品一次剂量名单 (自己维护)");
                });
            ...
            modelBuilder.Entity("YiJian.DoctorsAdvices.Entities.Prescription", b =>
                {
                    ...
                    b.Property<int>("BillState")
                        .HasColumnType("int")
                        .HasComment("订单状态, 0.未缴费 1.已缴费 -1.已作废 2.已执行,3.已退费");
                    ...
                    b.ToTable("RC_Prescription", (string)null);

                    b.HasComment("处方号管理类");
                });

            modelBuilder.Entity("YiJian.Emrs.Entities.EmrUsedAdviceRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("UsedAt")
                        .HasColumnType("datetime2")
                        .HasComment("使用时间（导入时间）");

                    b.HasKey("Id");

                    b.ToTable("RC_EmrUsedAdviceRecord", (string)null);

                    b.HasComment("使用过的医嘱记录信息");
                });

            modelBuilder.Entity("YiJian.OwnMedicines.Entities.OwnMedicine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Index")
                        .HasColumnType("int")
                        .HasComment("前端定位索引，自己录入自己定位");

                    b.Property<bool>("IsPush")
                        .HasColumnType("bit")
                        .HasComment("标记是否已经推送过,默认是否");
                    ...
                    b.ToTable("RC_OwnMedicine", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipe.DoctorSummary", b =>
                {
                    ...
                    b.ToTable("RC_DoctorSummary", (string)null);

                    b.HasComment("急诊医生会议纪要");
                });
            ...
            modelBuilder.Entity("YiJian.Recipe.NovelCoronavirusRna", b =>
                {
                    ...
                    b.ToTable("RC_NovelCoronavirusRna", (string)null);

                    b.HasComment("新冠RNA检测申请");
                });
            ...
            modelBuilder.Entity("YiJian.Recipe.OperationApply", b =>
                {
                    ...
                    b.ToTable("Oper_OperationApply", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipe.Packages.Package", b =>
                {
                    ...
                    b.ToTable("RC_Package", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipe.Packages.PackageGroup", b =>
                {
                    ...
                    b.ToTable("RC_PackageGroup", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipe.Packages.PackageProject", b =>
                {
                    ...
                    b.Property<bool>("IsCriticalPrescription")
                        .HasColumnType("bit")
                        .HasComment("是否处方权");
                    ...
                    b.ToTable("RC_PackageProject", (string)null);

                    b.HasComment("医嘱套餐-项目");
                });
            ...
            modelBuilder.Entity("YiJian.Recipe.SettingPara", b =>
                {
                    ...
                    b.ToTable("RC_SettingPara", (string)null);

                    b.HasComment("会诊配置");
                });

            modelBuilder.Entity("YiJian.Recipe.UserSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RC_UserSetting", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.Basic.RecipeExamProp", b =>
                {
                    ...
                    b.Property<string>("FirstCatalogCode")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasComment("一级目录编码");

                    b.Property<string>("FirstCatalogName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)")
                        .HasComment("一级分类名称");
                    ...
                    b.Property<string>("GuideName")
                        ...
                        .HasComment("指引名称 关联 ExamNote表name");
                    ...
                    b.ToTable("RC_ProjectExamProp", (string)null);

                    b.HasComment("医嘱-检查属性");
                });
            ...
            modelBuilder.Entity("YiJian.Recipes.Basic.RecipeLabProp", b =>
                {
                    ...
                    b.Property<string>("AddCard")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)")
                        .HasComment("加卡片类型 15.孕母血清胎儿唐氏综合征筛查申请单(早、中期)14.新型冠状病毒RNA检测申请单13.基于孕妇外周血胎儿 基于孕妇外周血胎儿13 、18 、21-三体综合征基因筛查申请单");
                    ...
                    b.Property<string>("GuideCatelogName")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("指引单大类");
                    ...
                    b.ToTable("RC_ProjectLabProp", (string)null);

                    b.HasComment("医嘱-检验属性");
                });
            ...
            modelBuilder.Entity("YiJian.Recipes.Basic.RecipeMedicineProp", b =>
                {
                    ...
                    b.ToTable("RC_ProjectMedicineProp", (string)null);

                    b.HasComment("医嘱-药品属性");
                });
            ...
            modelBuilder.Entity("YiJian.Recipes.Basic.RecipeProject", b =>
                {
                    ...
                    b.ToTable("RC_Project", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.Basic.RecipeTreatProp", b =>
                {
                    ...
                    b.ToTable("RC_ProjectTreatrop", (string)null);

                    b.HasComment("医嘱-处置属性");
                });
            ...
            modelBuilder.Entity("YiJian.Recipes.DoctorsAdvices.Entities.DoctorsAdvice", b =>
                {
                    ...
                    b.Property<bool>("IsAdditionalPrice")
                        .HasColumnType("bit")
                        .HasComment("是否是加收价格 1=是加收价格， 0=不是加收价格");
                    ...
                    b.Property<string>("MeducalInsuranceName")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("医保统一名称");
                    ...
                    b.Property<string>("PrescriptionFlag")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("分方标记");
                    ...
                    b.Property<int>("SequenceNo")
                        .HasColumnType("int")
                        .HasComment("单号序号，同一个处方单，单号从1开始递增");
                    ...
                    b.ToTable("RC_DoctorsAdvice", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.DoctorsAdvices.Entities.DoctorsAdviceAudit", b =>
                {
                    ...
                    b.ToTable("RC_DoctorsAdviceAudit", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.DoctorsAdvices.Entities.LisItem", b =>
                {
                    ...
                    b.ToTable("RC_LisItem", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.DoctorsAdvices.Entities.PacsItem", b =>
                {
                    ...
                    b.ToTable("RC_PacsItem", (string)null);

                    b.HasComment("检查小项");
                });

            modelBuilder.Entity("YiJian.Recipes.DoctorsAdvices.Entities.PacsPathologyItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ApplyForObjective")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("申请目的");

                    b.Property<string>("DrawMaterialsPart")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("取材部位");
                    ...
                    b.Property<DateTime>("RegularTime")
                        .HasColumnType("datetime2")
                        .HasComment("固定时间");

                    b.Property<string>("SpecificityInfect")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("特异性感染");
                    ...
                    b.ToTable("RC_PacsPathologyItem", (string)null);

                    b.HasComment("检查病理小项");
                });

            modelBuilder.Entity("YiJian.Recipes.DoctorsAdvices.Entities.PacsPathologyItemNo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RC_PacsPathologyItemNo", (string)null);

                    b.HasComment("检查病理小项序号");
                });
            ...
            modelBuilder.Entity("YiJian.Recipes.DoctorsAdvices.Entities.Prescribe", b =>
                {
                    ...
                    b.Property<decimal>("CommitHisDosageQty")
                        .HasColumnType("decimal(18,2)")
                        .HasComment("急诊换算之后-每次剂量-标准单位的数量");
                    ...
                    b.Property<decimal>("HisDosageQty")
                        .HasColumnType("decimal(18,2)")
                        .HasComment("每次剂量-标准单位的数量");

                    b.Property<string>("HisDosageUnit")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasComment("每次剂量-标准单位");

                    b.Property<string>("HisUnit")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasComment("剂量单位-视图里面的那个Unit单位");
                    ...
                    b.ToTable("RC_Prescribe", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.DoctorsAdvices.Entities.PrintInfo", b =>
                {
                    ...
                    b.ToTable("RC_PrintInfo", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.DoctorsAdvices.Entities.Toxic", b =>
                {
                    ...
                    b.ToTable("RC_Toxic", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.DoctorsAdvices.Entities.Treat", b =>
                {
                    ...
                    b.ToTable("RC_Treat", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.GroupConsultation.GroupConsultation", b =>
                {
                    ...
                    b.ToTable("RC_GroupConsultations", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.InviteDoctor.InviteDoctor", b =>
                {
                    ...
                    b.ToTable("RC_InviteDoctors", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.Preferences.Entities.QuickStartAdvice", b =>
                {
                    ...
                    b.ToTable("RC_QuickStartAdvice", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.Preferences.Entities.QuickStartCatalogue", b =>
                {
                    ...
                    b.ToTable("RC_QuickStartCatalogue", (string)null);
            ...
            modelBuilder.Entity("YiJian.Recipes.Preferences.Entities.QuickStartMedicine", b =>
                {
                    ...
                    b.ToTable("RC_QuickStartMedicine", (string)null);

                    b.HasComment("快速开嘱的药品");
                });
            ...
            modelBuilder.Entity("YiJian.Sequences.Entities.MySequence", b =>
                {
                    ...
                    b.ToTable("RC_MySequence", (string)null);

                    b.HasComment("我的系列号管理器");
                });
