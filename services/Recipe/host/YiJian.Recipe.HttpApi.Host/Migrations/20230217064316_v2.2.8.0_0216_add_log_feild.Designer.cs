...
namespace YiJian.Recipe.Migrations
{
    ...
    [Migration("20230217064316_v2.2.8.0_0216_add_log_feild")]
    partial class v2280_0216_add_log_feild
    {
            ...
            modelBuilder.Entity("YiJian.AuditLogs.Entities.AuditLog", b =>
                {
                    ...
                    b.ToTable("RC_AuditLog");

                    b
                        .HasComment("HIS接口审计日志");
                });
            ...
            modelBuilder.Entity("YiJian.DoctorsAdvices.Entities.DoctorsAdviceMap", b =>
                {
                    ...
                    b.ToTable("RC_DoctorsAdviceMap");

                    b
                        .HasComment("医嘱映射表,只映射一个自增的Id");
                });
            ...
            modelBuilder.Entity("YiJian.DoctorsAdvices.Entities.ImmunizationRecord", b =>
                {
                    ...
                    b.ToTable("RC_ImmunizationRecord");
            ...
            modelBuilder.Entity("YiJian.Emrs.Entities.EmrUsedAdviceRecord", b =>
                {
                    ...
                    b.ToTable("RC_EmrUsedAdviceRecord");

                    b
                        .HasComment("使用过的医嘱记录信息");
                });
