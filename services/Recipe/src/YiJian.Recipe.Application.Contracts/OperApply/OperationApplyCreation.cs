...
namespace YiJian.Recipe
{
    ...
    public partial class OperationApplyCreation
    {
        /// <summary>
        /// 主键id，新增不传该参数，修改该参数必填
        /// </summary>
        ...
        /// 手术等级
        /// </summary>
        [Required(ErrorMessage = "手术等级必填")]
        public string OperationLevel { get; set; }

        /// <summary>
        /// 申请科室编码
        /// </summary>
        [Required(ErrorMessage = "申请科室必填")]
        ...
        /// 手术位置
        /// </summary>
        [Required(ErrorMessage = "手术位置必填")]
        public string OperationLocation { get; set; }

        /// <summary>
        /// 手术医生编码
        /// </summary>
        [Required(ErrorMessage = "手术医生必填")]
        ...
        /// 手术计划时间
        /// </summary>
        public string OperationPlanTime { get; set; }
