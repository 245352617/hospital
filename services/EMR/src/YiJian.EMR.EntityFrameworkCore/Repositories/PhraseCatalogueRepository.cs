...
namespace YiJian.EMR.Repositories
{
    ...
    /// 常用语目录
    /// </summary>
    public class PhraseCatalogueRepository : EfCoreRepository<EMRDbContext, PhraseCatalogue, int>, IPhraseCatalogueRepository
    {
        /// <summary>
        /// 常用语目录
        /// </summary>
        /// <param name="dbContextProvider"></param>
        public PhraseCatalogueRepository(IDbContextProvider<EMRDbContext> dbContextProvider) 
