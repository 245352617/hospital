...
namespace YiJian.EMR.Repositories
{
    ...
    /// 常用语
    /// </summary>
    public class PhraseRepository : EfCoreRepository<EMRDbContext, Phrase, int>, IPhraseRepository
    {
        public PhraseRepository(IDbContextProvider<EMRDbContext> dbContextProvider) 
