...
namespace SamJan.MicroService.PreHospital.TriageService.Migrations
{
    ...
    [Migration("20231229072630_add_ReportPermission")]
    partial class add_ReportPermission
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.ConsequenceInfo", b =>
                {
                    ...
                    b.Property<bool>("ChangeTriage")
                        .HasColumnType("bit")
                        .HasComment("变更就诊")
                        .HasMaxLength(256);

                    b.Property<string>("ChangeTriageReasonCode")
                        .HasColumnType("nvarchar(256)")
                        .HasComment("变更就诊原因代码")
                        .HasMaxLength(256);

                    b.Property<string>("ChangeTriageReasonName")
                        .HasColumnType("nvarchar(256)")
                        .HasComment("变更就诊原因")
                        .HasMaxLength(256);
                    ...
                    b.Property<string>("TriageAreaCode")
                        .HasColumnType("nvarchar(60)")
                        .HasComment("分诊分区代码")
                        .HasMaxLength(60);

                    b.Property<string>("TriageAreaName")
                        .HasColumnType("nvarchar(60)")
                        .HasComment("分诊分区")
                        .HasMaxLength(60);
            ...
            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.DutyTelephone", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.InformPatInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("ArriveHospitalTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("ConsultationDept")
                        .HasColumnType("nvarchar(200)")
                        .HasComment("会诊科室")
                        .HasMaxLength(200);
                    ...
                    b.Property<string>("DiseaseIdentification")
                        .HasColumnType("nvarchar(200)")
                        .HasComment("病种判断")
                        .HasMaxLength(200);
                    ...
                    b.Property<string>("HelpCauseName")
                        .HasColumnType("nvarchar(50)")
                        .HasComment("呼救原因(主诉)")
                        .HasMaxLength(50);
                    ...
                    b.Property<DateTime?>("InformTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("SendToHospital")
                        .HasColumnType("nvarchar(200)")
                        .HasComment("送往医院")
                        .HasMaxLength(200);
                    ...
                    b.ToTable("Triage_InformPatInfo");
            ...
            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.PatientInfo", b =>
                {
                    ...
                    b.Property<string>("ElectronCertNo")
                        .HasColumnType("nvarchar(50)")
                        .HasComment("医保电子凭证")
                        .HasMaxLength(50);
                    ...
                    b.Property<bool>("IsSyncRegister")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("IsUntreatedOver")
                        .HasColumnType("bit")
                        .HasComment("是否过号");
                    ...
                    b.Property<string>("SpecialAccountTypeCode")
                        .HasColumnType("nvarchar(50)")
                        .HasComment("特约记账类型编码")
                        .HasMaxLength(50);

                    b.Property<string>("SpecialAccountTypeName")
                        .HasColumnType("nvarchar(50)")
                        .HasComment("特约记账类型名称")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.PatientInfoChangeRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("OperatedCode")
                        .HasColumnType("nvarchar(500)")
                        .HasComment("操作人编码")
                        .HasMaxLength(500);

                    b.Property<string>("OperatedName")
                        .HasColumnType("nvarchar(500)")
                        .HasComment("操作人名称")
                        .HasMaxLength(500);
                    ...
                    b.ToTable("Triage_PatientInfoChangeRecord");

                    b.HasComment("病人信息变更记录表");
                });
            ...
            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.ReportDeathCount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("DeathCountChanged")
                        .HasColumnType("int")
                        .HasComment("手动修改人数");
                    ...
                    b.ToTable("Rpt_DeathCount");

                    b.HasComment("死亡人数统计");
                });

            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.ReportFeverCount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("FeverCount")
                        .HasColumnType("int")
                        .HasComment("系统统计人数");

                    b.Property<int?>("FeverCountChanged")
                        .HasColumnType("int")
                        .HasComment("手动修改人数");
            ...
            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.ReportPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Dict_ReportPermission");

                    b.HasComment("分诊报表权限设置");
                });

            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.ReportRescueAndView", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Rpt_RescueAndView");

                    b.HasComment("抢救区、留观区统计");
                });
            ...
            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.ReportTriageCount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("TriageCount")
                        .HasColumnType("int")
                        .HasComment("系统统计人数");

                    b.Property<int?>("TriageCountChanged")
                        .HasColumnType("int")
                        .HasComment("手动修改人数");
                    ...
                    b.ToTable("Rpt_TriageCount");

                    b.HasComment("分诊人数统计");
                });

            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.ScoreDict", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AssociatedOptions")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("关联选项");
                    ...
                    b.Property<int>("RemarkStyle")
                        .HasColumnType("int")
                        .HasComment("备注文本样式，-1：无，1：纯文本，2：Html");
            ...
            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.TagSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Sms_TagSettings");

                    b.HasComment("标签管理");
                });

            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.TextMessageRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Sms_TextMessageRecord");

                    b.HasComment("短信消息记录");
                });

            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.TextMessageTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Sms_TextMessageTemplate");
            ...
            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.TriageConfig", b =>
                {
                    ...
                    b.Property<string>("SixCenterValue")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("六大中心值");
                    ...
                    b.Property<int>("TriageConfigType")
                        .HasColumnType("int")
                        .HasComment("分诊设置类型  1001:绿色通道 1002:群伤事件 1003:费别 1004:来院方式 1005:科室配置 1006:院前分诊去向 1013:院前分诊评分类型 具体以TriageDict数据为准");
            ...
            modelBuilder.Entity("SamJan.MicroService.PreHospital.TriageService.InformPatInfo", b =>
                {
                    b.HasOne("SamJan.MicroService.PreHospital.TriageService.PatientInfo", null)
                        .WithOne("Inform")
                        .HasForeignKey("SamJan.MicroService.PreHospital.TriageService.InformPatInfo", "PatientInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
