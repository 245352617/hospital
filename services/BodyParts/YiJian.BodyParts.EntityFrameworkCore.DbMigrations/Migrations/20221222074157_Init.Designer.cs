...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YiJian.BodyParts.Model.CanulaDynamic", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("YiJian.BodyParts.Model.IcuCanula", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("主键");
            ...
            modelBuilder.Entity("YiJian.BodyParts.Model.IcuNursingCanula", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("主键");
                    ...
                    b.Property<int>("TubeDrawState")
                        .HasColumnType("int")
                        .HasComment("管道状态（0拔管，1换管，2取消拔管，-1其他）");
            ...
            modelBuilder.Entity("YiJian.BodyParts.Model.IcuPatientRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("ID");
                    ...
                    b.Property<string>("BedNum")
                        .HasColumnType("nvarchar(20)")
                        .HasComment("采集器(绑定床位)的编号 ")
                        .HasMaxLength(20);

                    b.Property<string>("ClinicDiagnosis")
                        .HasColumnType("nvarchar(1000)")
                        .HasComment("临床诊断")
                        .HasMaxLength(1000);

                    b.Property<int?>("CriticaDegree")
                        .HasColumnType("int")
                        .HasComment("危重程度（0：其他，1：病危，2：病重）");
                    ...
                    b.Property<string>("InDeptCode")
                        .HasColumnType("nvarchar(20)")
                        .HasComment("来源科室代码")
                        .HasMaxLength(20);

                    b.Property<string>("InDeptName")
                        .HasColumnType("nvarchar(100)")
                        .HasComment("来源科室名称")
                        .HasMaxLength(100);

                    b.Property<string>("InDeptNurseCode")
                        .HasColumnType("nvarchar(20)")
                        .HasComment("入科交接护士代码")
                        .HasMaxLength(20);

                    b.Property<string>("InDeptNurseName")
                        .HasColumnType("nvarchar(20)")
                        .HasComment("入科交接护士名称")
                        .HasMaxLength(20);

                    b.Property<int>("InDeptState")
                        .HasColumnType("int")
                        .HasComment("是否在科（1：在科；0：出科；2，取消入科，3:待入科，4:待出科)");

                    b.Property<DateTime>("InDeptTime")
                        .HasColumnType("datetime")
                        .HasComment("入科时间");

                    b.Property<DateTime?>("InDeptTransferTime")
                        .HasColumnType("datetime")
                        .HasComment("入科交接时间");

                    b.Property<string>("InHosId")
                        .HasColumnType("nvarchar(20)")
                        .HasComment("住院号")
                        .HasMaxLength(20);
                    ...
                    b.Property<int?>("InPlan")
                        .HasColumnType("int")
                        .HasComment("入科计划（0：非计划转入，1：计划转入）");

                    b.Property<int?>("InReason")
                        .HasColumnType("int")
                        .HasComment("转入原因（非计划转入原因：1：缺少病情变化的预警，2：手术因素，3：麻醉因素；计划转入原因：4：危及生命的急性器官功能不全，5：具有潜在危及生命的高危因素，6：慢性器官功能不全急性加重，7：围手术期危重患者，0：其他）");

                    b.Property<int?>("InReturn")
                        .HasColumnType("int")
                        .HasComment("重返（0：否，1：24小时重返，2：48小时重返）");

                    b.Property<int?>("InSource")
                        .HasColumnType("int")
                        .HasComment("入科来源（7-入院、5-手术、6-外院转入、8-转入）");

                    b.Property<string>("InStandard")
                        .HasColumnType("nvarchar(1000)")
                        .HasComment("转入标准")
                        .HasMaxLength(1000);
                    ...
                    b.Property<string>("InsulateFlag")
                        .HasColumnType("nvarchar(20)")
                        .HasComment("隔离标志（Y ：隔离，N：不隔离）")
                        .HasMaxLength(20);

                    b.Property<bool>("IsDoctorConfirm")
                        .HasColumnType("bit")
                        .HasComment("是否医生确认");
                    ...
                    b.Property<int?>("NurseGrade")
                        .HasColumnType("int")
                        .HasComment("护理级别（1：一级护理，2：二级护理，3：三级护理，4.特级护理）");
                    ...
                    b.Property<int>("NurseType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("护理类型（0：其他，1：基础护理，2：特殊护理，3：辩证施护）")
                        .HasDefaultValue(0);

                    b.Property<string>("OperationNurseId")
                        .HasColumnType("nvarchar(20)")
                        .HasComment("最后操作人ID")
                        .HasMaxLength(20);

                    b.Property<string>("OperationNurseName")
                        .HasColumnType("nvarchar(20)")
                        .HasComment("最后操作人名称")
                        .HasMaxLength(20);
                    ...
                    b.Property<string>("OutDeptNurseCode")
                        .HasColumnType("nvarchar(20)")
                        .HasComment("出科交接护士工号")
                        .HasMaxLength(20);

                    b.Property<string>("OutDeptNurseName")
                        .HasColumnType("nvarchar(40)")
                        .HasComment("出科交接护士名称")
                        .HasMaxLength(40);
                    ...
                    b.Property<DateTime?>("OutDeptTransferTime")
                        .HasColumnType("datetime")
                        .HasComment("出科交接时间");

                    b.Property<string>("OutStandard")
                        .HasColumnType("nvarchar(1000)")
                        .HasComment("转出标准")
                        .HasMaxLength(1000);

                    b.Property<int?>("OutState")
                        .HasColumnType("int")
                        .HasComment("出科状态(1：恶化，2：好转，3：未愈)");

                    b.Property<int?>("OutTurnover")
                        .HasColumnType("int")
                        .HasComment("出科转归(1：出院，2：转出，3：死亡，4：转上级医院)");
                    ...
                    b.Property<string>("PI_ID")
                        .IsRequired()
                        .HasColumnType("nvarchar(20)")
                        .HasComment("患者id(通过业务构造的流水号，每个患者每次入科号码唯一)")
                        .HasMaxLength(20);

                    b.Property<int?>("PatState")
                        .HasColumnType("int")
                        .HasComment("病人状态 1:正常入科(入院/入科转icu实床) 2:紧急入科 3:虚床转实床 4:病人紧急入科，通过消息更新后");
                    ...
                    b.Property<string>("SpDoctorCode")
                        .HasColumnType("nvarchar(20)")
                        .HasComment("专科医生")
                        .HasMaxLength(20);

                    b.Property<string>("SpDoctorName")
                        .HasColumnType("nvarchar(20)")
                        .HasComment("专科医生名称")
                        .HasMaxLength(20);
                    ...
                    b.Property<decimal?>("UnsettledCost")
                        .HasColumnType("decimal(18, 2)")
                        .HasComment("结余");
                    ...
                    b.HasIndex("ArchiveId")
                        .HasName("Index_ArchiveId");

                    b.HasIndex("InDeptState")
                        .HasName("Index_InDeptState");

                    b.HasIndex("InDeptTime")
                        .HasName("Index_InDeptTime");

                    b.HasIndex("InHosId")
                        .HasName("Index_InHosId");

                    b.HasIndex("PI_ID")
                        .HasName("Index_PI_ID");

                    b.HasIndex("VisitNum")
                        .HasName("Index_VisitNum");

                    b.ToTable("IcuPatientRecord");
