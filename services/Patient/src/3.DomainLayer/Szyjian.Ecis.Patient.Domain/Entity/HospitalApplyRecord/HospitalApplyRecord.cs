...
namespace Szyjian.Ecis.Patient
{
    ...
    /// 住院记录
    /// </summary>
    [Table(Name = "Pat_HosptialApplyRecord")]
    public class HospitalApplyRecord
    {
        /// <summary>
        /// 主键
        /// </summary>
        [Column(Name = "PH_ID", IsIdentity = true, IsPrimary = true)]
        ...
        /// 病区收治编码
        /// </summary>
        [Column(DbType = "nvarchar(20)", OldName = "AdmissionType")]
