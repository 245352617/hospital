...
namespace Szyjian.Ecis.Patient.Application.Contracts
{
    public class RescueResponseDto
    {
        ...
        [Excel("入抢操作人", 450)]
        public string InRescue { get; set; }

        [Excel("出抢操作人", 440)]
        public string OutRescue { get; set; }

        public DateTime InRescueTime { get; set; }

        [Excel("入抢时间", 430)]
        public string InRescueTime1 { get; set; }
        ...
        public DateTime? OutRescueTime { get; set; }

        [Excel("出抢时间", 410)]
        public string OutRescueTime1 { get; set; }

        public double RescueRetentionTime { get; set; }

        [Excel("时长", 400)]
        public string RescueRetentionTime1 { get; set; }

        [Excel("小时", 390)]
        public string RescueRetentionTime2 { get; set; }
