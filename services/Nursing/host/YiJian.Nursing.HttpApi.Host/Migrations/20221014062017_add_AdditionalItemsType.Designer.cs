...
namespace YiJian.Nursing.Migrations
{
    ...
    [Migration("20221014062017_add_AdditionalItemsType")]
    partial class add_AdditionalItemsType
    {
            ...
            modelBuilder.Entity("YiJian.Nursing.Recipes.Entities.Recipe", b =>
                {
                    ...
                    b.Property<int>("NursingStatus")
                        .HasColumnType("int")
                        .HasComment("护理医嘱状态:0=未知,1=已驳回,2=已确认,3=已确认,4=已提交(医生站)->无执行(护士站),5=已执行,6=已停止(医生站)->停复核(护士站),7=已停嘱(医生站)->停复核(护士站),99=已作废");
