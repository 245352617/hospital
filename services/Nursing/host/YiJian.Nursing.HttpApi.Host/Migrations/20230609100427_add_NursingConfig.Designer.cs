...
namespace YiJian.Nursing.Migrations
{
    ...
    [Migration("20230609100427_add_NursingConfig")]
    partial class add_NursingConfig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YiJian.Nursing.Canula", b =>
                {
                    ...
                    b.ToTable("Duct_Canula", (string)null);

                    b.HasComment("表:导管护理记录信息");
                });
            ...
            modelBuilder.Entity("YiJian.Nursing.CanulaDynamic", b =>
                {
                    ...
                    b.ToTable("Duct_CanulaDynamic", (string)null);

                    b.HasComment("表:导管参数动态");
                });
            ...
            modelBuilder.Entity("YiJian.Nursing.CanulaPart", b =>
                {
                    ...
                    b.ToTable("Duct_CanulaPart", (string)null);

                    b.HasComment("表:人体图-编号字典");
                });

            modelBuilder.Entity("YiJian.Nursing.Config.NursingConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("NursingNursingConfig", (string)null);
            ...
            modelBuilder.Entity("YiJian.Nursing.Dict", b =>
                {
                    ...
                    b.ToTable("Duct_Dict", (string)null);

                    b.HasComment("表:导管字典-通用业务");
                });
            ...
            modelBuilder.Entity("YiJian.Nursing.NursingCanula", b =>
                {
                    ...
                    b.ToTable("Duct_NursingCanula", (string)null);

                    b.HasComment("表:导管护理信息");
                });
            ...
            modelBuilder.Entity("YiJian.Nursing.ParaItem", b =>
                {
                    ...
                    b.ToTable("Duct_ParaItem", (string)null);

                    b.HasComment("表:导管护理项目表");
                });
            ...
            modelBuilder.Entity("YiJian.Nursing.RecipeExecutes.Entities.RecipeExec", b =>
                {
                    ...
                    b.Property<string>("ExecuteNurseCode")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasComment("执行护士");

                    b.Property<string>("ExecuteNurseName")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("执行护士名称");

                    b.Property<DateTime?>("ExecuteNurseTime")
                        .HasColumnType("datetime2")
                        .HasComment("护士执行时间");
                    ...
                    b.Property<decimal>("ReserveDosage")
                        .HasPrecision(18, 4)
                    ...
                    b.Property<decimal>("TotalDiscardDosage")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)")
                        .HasComment("废弃量");

                    b.Property<decimal>("TotalDosage")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)")
                        .HasComment("总剂量");

                    b.Property<decimal>("TotalExecDosage")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)")
                        .HasComment("总执行量");

                    b.Property<decimal>("TotalRemainDosage")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)")
                        .HasComment("总余量");

                    b.Property<string>("TwoCheckNurseCode")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasComment("二次核对护士");

                    b.Property<string>("TwoCheckNurseName")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("二次核对护士名称");

                    b.Property<DateTime?>("TwoCheckTime")
                        .HasColumnType("datetime2")
                        .HasComment("二次核对时间");
                    ...
                    b.ToTable("NursingRecipeExec", (string)null);
            ...
            modelBuilder.Entity("YiJian.Nursing.RecipeExecutes.Entities.RecipeExecHistory", b =>
                {
                    ...
                    b.ToTable("NursingRecipeExecHistory", (string)null);

                    b.HasComment("医嘱执行历史记录");
                });

            modelBuilder.Entity("YiJian.Nursing.RecipeExecutes.Entities.RecipeExecRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("DiscardDosage")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)")
                        .HasComment("废弃量");
                    ...
                    b.Property<int>("ExecRecordStatus")
                        .HasColumnType("int")
                        .HasComment("执行记录状态");
                    ...
                    b.Property<decimal>("RemainDosage")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)")
                        .HasComment("余量");
                    ...
                    b.ToTable("NursingRecipeExecRecord", (string)null);
            ...
            modelBuilder.Entity("YiJian.Nursing.Recipes.Entities.Lis", b =>
                {
                    ...
                    b.ToTable("NursingLis", (string)null);
            ...
            modelBuilder.Entity("YiJian.Nursing.Recipes.Entities.OwnMedicine", b =>
                {
                    ...
                    b.ToTable("NursingOwnMedicine", (string)null);
            ...
            modelBuilder.Entity("YiJian.Nursing.Recipes.Entities.Pacs", b =>
                {
                    ...
                    b.ToTable("NursingPacs", (string)null);
            ...
            modelBuilder.Entity("YiJian.Nursing.Recipes.Entities.Prescribe", b =>
                {
                    ...
                    b.ToTable("NursingPrescribe", (string)null);
            ...
            modelBuilder.Entity("YiJian.Nursing.Recipes.Entities.Recipe", b =>
                {
                    ...
                    b.ToTable("NursingRecipe", (string)null);
            ...
            modelBuilder.Entity("YiJian.Nursing.Recipes.Entities.RecipeHistory", b =>
                {
                    ...
                    b.ToTable("NursingRecipeHistory", (string)null);
            ...
            modelBuilder.Entity("YiJian.Nursing.Recipes.Entities.Treat", b =>
                {
                    ...
                    b.ToTable("NursingTreat", (string)null);
            ...
            modelBuilder.Entity("YiJian.Nursing.Settings.ParaModule", b =>
                {
                    ...
                    b.ToTable("Duct_ParaModule", (string)null);

                    b.HasComment("表:导管模块参数");
                });

            modelBuilder.Entity("YiJian.Nursing.Temperatures.ClinicalEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("UpDownFlag")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasComment("上下标");

                    b.Property<string>("UpDownFlagCode")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasComment("上下标编码");
                    ...
                    b.ToTable("NursingClinicalEvent", (string)null);

                    b.HasComment("临床事件表");
                });

            modelBuilder.Entity("YiJian.Nursing.Temperatures.Temperature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("NursingTemperature", (string)null);

                    b.HasComment("体温单表");
                });

            modelBuilder.Entity("YiJian.Nursing.Temperatures.TemperatureDynamic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("TemperatureRecordId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("体温记录表主键");
                    ...
                    b.ToTable("NursingTemperatureDynamic", (string)null);

                    b.HasComment("体温表动态属性");
                });

            modelBuilder.Entity("YiJian.Nursing.Temperatures.TemperatureRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MeasurePosition")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)")
                        .HasComment("测量位置");
                    ...
                    b.Property<decimal?>("RetestTemperature")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)")
                        .HasComment("复测体温（单位℃）");
                    ...
                    b.ToTable("NursingTemperatureRecord", (string)null);
            ...
            modelBuilder.Entity("YiJian.Nursing.Temperatures.TemperatureDynamic", b =>
                {
                    b.HasOne("YiJian.Nursing.Temperatures.Temperature", null)
                        .WithMany("TemperatureDynamics")
            ...
            modelBuilder.Entity("YiJian.Nursing.Temperatures.Temperature", b =>
                {
                    b.Navigation("TemperatureDynamics");
