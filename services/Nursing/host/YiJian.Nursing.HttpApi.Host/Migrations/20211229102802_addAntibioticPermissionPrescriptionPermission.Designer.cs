...
namespace YiJian.Nursing.Migrations
{
    ...
    [Migration("20211229102802_addAntibioticPermissionPrescriptionPermission")]
    partial class addAntibioticPermissionPrescriptionPermission
    {
            ...
            modelBuilder.Entity("YiJian.Nursing.Recipes.Entities.Recipe", b =>
                {
                    ...
                    b.Property<int>("NursingStatus")
                        .HasColumnType("int")
                        .HasComment("护理医嘱状态:0=未知,1=已提交(医生站)->未执行(护士站),2=已确认,3=已作废,4=已停止(医生站)->停复核(护士站),5=已提交(医生站)->需要复核->未复核(护士站),6=已驳回,7=已执行,8:已停嘱(医生站)->停复核(护士站),18=已缴费,19=已退费");
