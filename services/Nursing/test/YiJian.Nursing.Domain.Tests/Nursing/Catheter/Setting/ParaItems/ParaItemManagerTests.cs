namespace YiJian.Nursing
{
    ...
    /// 表:护理项目表 领域服务测试
    /// </summary>
    public class ParaItemManagerTests : NursingDomainTestBase
    {
        private readonly ParaItemManager _paraItemManager;

        public ParaItemManagerTests()
        {            
        ...
        public async Task CreateAsyncTestAsync()
        {
            ...
            var paraItem = await _paraItemManager.CreateAsync(_guidGenerator.Create(), 
                deptCode,// 科室编号
                moduleCode,     // 参数所属模块
                paraCode,       // 项目代码
                paraName,       // 项目名称
